...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"扫描二维码" andClass:self andSEL:@selector(backBtn)];
...
-(void)makeUI
{
    ...
    webView=[[UIWebView alloc] initWithFrame:CGRectMake(0, 64.6*screenWidth/320.0, self.view.frame.size.width, self.view.frame.size.height-64.6*screenWidth/320.0)];
