...
//下级推广数
@property (nonatomic,retain)NSString * tgRecordSumLev1;
//下下级推广数
@property (nonatomic,retain)NSString * tgRecordSumLev2;
...
@property (nonatomic,retain)NSString * yu;      //余额
@property (nonatomic,retain)NSString * KYyue;    //可用余额
@property (nonatomic,retain)NSString * KTyue;   //可提现金额
...
@property (nonatomic,retain)NSString * yuejiFen;
...
//近期交易金额
@property (nonatomic,retain)NSString * numGet;
//近期提现金额
@property (nonatomic,retain)NSString * numOut;
//近期交易笔数
@property (nonatomic,retain)NSString * numNum;
//是否首次交易
@property(nonatomic ,retain) NSString *isFirstTrans;
//是否实名
@property (nonatomic, retain) NSString *isAuthentication;
//银行卡是否默认
@property(nonatomic,retain)NSString *moren;
//结算卡编号
@property(nonatomic,retain)NSString *moRenNun;
//saomiao卡号
@property (nonatomic,retain)NSString * kanum;
...
//多多通讯
@property(nonatomic,retain) NSString *telmoney;
