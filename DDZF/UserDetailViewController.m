...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"账户详情" andClass:self andSEL:@selector(bacClick:)];
...
-(void)makeUI
{
    ...
    _sv=[[UIScrollView alloc] initWithFrame:CGRectMake(0,64*screenWidth/320, screenWidth, screenHeight)];
    _sv.backgroundColor=[UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:1.0];
