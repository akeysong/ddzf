...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"更改交易密码" andClass:self andSEL:@selector(bacClick:)];
...
-(void)makeUI
{
    ...
    btn.backgroundColor=[UIColor colorWithRed:0.19 green:0.8 blue:0.0 alpha:1.0];
...
//    if(_change.text!=nil&&_change.text.length==6&&![_now.text isEqualToString:user.yanText])
//    {
//        NSLog(@"shuchuwei %@,%@",_now.text,user.yanText);
...
//    }
    else
    {
        ...
        {
            [self toastResult:[dic objectForKey:@"respCode"]];
            return;
        }
