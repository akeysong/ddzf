...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"密码管理" andClass:self andSEL:@selector(bacClick:)];
...
-(void)makeUI
{
    ...
    for(int i=0;i<3;i++)
    {
        ...
        _btn.frame=CGRectMake(0, (70+i*41)*screenWidth/320, self.view.frame.size.width, 40*screenWidth/320);
