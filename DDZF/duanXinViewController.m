...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"短信收款" andClass:self andSEL:@selector(baclick:)];
...
-(void)makeUI
{
    ...
    _scr.backgroundColor=[UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:1];
    _scr.contentSize = CGSizeMake(0, self.view.frame.size.height-64*screenWidth/320.0);
  ...
  //  白色背景
    UIView *view=[[UIView alloc] initWithFrame:CGRectMake(10*screenWidth/320.0, 50*screenWidth/320.0, self.view.frame.size.width-20*screenWidth/320.0, 50*screenWidth/320.0)];
    ...
    _phone.font=[UIFont systemFontOfSize:14*screenWidth/320.0];
...
//    _phone.keyboardType = UIKeyboardTypeNumberPad;
    ...
    //手机号码
    UILabel *numLab=[[UILabel alloc] initWithFrame:CGRectMake(10*screenWidth/320.0, 10*screenWidth/320.0, 70*screenWidth/320.0, 30*screenWidth/320.0)];
    numLab.text=@"手机号码";
    ...
    //竖线
    UIView *line=[[UIView alloc] initWithFrame:CGRectMake(80*screenWidth/320.0, 15*screenWidth/320.0, 1, 20*screenWidth/320.0)];
    line.backgroundColor=[UIColor blackColor];
    [view addSubview:line];
    
    UILabel *tixingLabel=[[UILabel alloc] initWithFrame:CGRectMake(100*screenWidth/320.0, 150*screenWidth/320.0, self.view.frame.size.width-150*screenWidth/320.0, 110*screenWidth/320.0)];
    tixingLabel.text=@"提示:\n  您正在短信充值,\n  为确保您的正常充值,\n  请准确填写对方手机号码!";
    tixingLabel.font=[UIFont systemFontOfSize:14*screenWidth/320.0];
    tixingLabel.numberOfLines=0;
    tixingLabel.textColor=[UIColor grayColor];
    tixingLabel.textAlignment=NSTextAlignmentLeft;
    [_scr addSubview:tixingLabel];
    
    //通讯录按钮
    UIButton *btn1=[UIButton buttonWithType:UIButtonTypeCustom];
    btn1.frame=CGRectMake(view.frame.size.width- 40*screenWidth/320, 10*screenWidth/320,30*screenWidth/320, 30*screenWidth/320);
    [btn1 setImage:[UIImage imageNamed:@"tongxunlu@2x.png"] forState:UIControlStateNormal];
    ...
    button.frame = CGRectMake(20*screenWidth/320, 300*screenWidth/320,screenWidth-40*screenWidth/320,50*screenWidth/320);
