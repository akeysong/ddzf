...
#import "User.h"
@interface jIRongLiCaiViewController ()<UIWebViewDelegate>
{
    UIWebView *_webview;
}
...
@implementation jIRongLiCaiViewController
...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"金融理财" andClass:self andSEL:@selector(bacClick:)];
