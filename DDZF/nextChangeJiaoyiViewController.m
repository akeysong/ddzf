...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"输入新密码" andClass:self andSEL:@selector(backClick:)];
...
-(void)btton:(UIButton*)btn
{
         ...
         else
    {
        ...
        {
            _alertView1= [[UIAlertView alloc]initWithTitle:@"密码更新成功" message:@"密码更新成功" delegate:self cancelButtonTitle:@"确认" otherButtonTitles:nil, nil];
            [_alertView1 show];
            _alertView1.tag=1;
