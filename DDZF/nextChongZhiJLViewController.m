//
//  nextChongZhiJLViewController.m
//  DDZF
//
...
#import "Header.h"
@interface nextChongZhiJLViewController ()
{
...
@implementation nextChongZhiJLViewController
...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"收款详情" andClass:self andSEL:@selector(bacClick:)];
