...
-(void)makeUI
{
  ...
  //   _textView.textAlignment = UITextAlignmentLeft;
   ...
   // _textView.text=user.ming;
    ...
    //网址
    _urlStr=[NSString stringWithFormat:@"%@/doPay.do?merId=%@&transSeqId=%@&credNo=%@&paySrc=%@",url1,user.merid,self.ding,self.ping,@"sms"];
    //固定短信内容
    ...
    duan.textAlignment=NSTextAlignmentLeft;
