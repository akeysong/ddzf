//
//  nextForgetViewController.m
//  DDZF
//
//  Created by 王健超 on 15/12/10.
...
#import "MyMD5.h"
#import "User.h"
@interface nextForgetViewController ()<UITextFieldDelegate>
{
...
@implementation nextForgetViewController
...
-(void)createN
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"找回密码" andClass:self andSEL:@selector(backClick:)];
