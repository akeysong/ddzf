...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"扫一扫" andClass:self andSEL:@selector(bacClick:)];
...
-(void)makeUI
{
    ...
    _alertLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 70*screenWidth/320.0, WIDTH, 30*screenWidth/320.0)];
    ...
    _imgView = [[UIImageView alloc] initWithFrame:CGRectMake(50, 114*screenWidth/320.0, WIDTH-100, WIDTH-100)];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    else
    {
        ...
        if (alertView.tag==3)
        {
            SaoMiaoViewController *svc=[[SaoMiaoViewController alloc] init];
            svc.string=stringValue;
