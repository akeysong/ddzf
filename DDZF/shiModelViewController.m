...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"fanhui.png"] andRightBBIImages:nil andTitle:@"拍照模板" andClass:self andSEL:@selector(bacClick)];
...
-(void)makeUI
{
    ...
    _scr = [[UIScrollView alloc] initWithFrame:CGRectMake(0,64*screenWidth/320.0, screenWidth, self.view.frame.size.height-64*screenWidth/320.0)];
    
    _scr.contentSize = CGSizeMake(0, 1400);
    _scr.backgroundColor=[UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:1.0];
