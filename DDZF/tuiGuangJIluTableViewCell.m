...
-(void)makeUI
{
    ...
    self.regMerName.backgroundColor=[UIColor greenColor];
    ...
    self.regMobile=[[UILabel alloc] initWithFrame:CGRectMake(160*screenWidth/320, 5*screenWidth/320, 150*screenWidth/320, 20*screenWidth/320)];
    self.regMobile.textColor=[UIColor grayColor];
    self.regMobile.textAlignment=NSTextAlignmentRight;
    ...
    self.isAuthentication=[[UILabel alloc] initWithFrame:CGRectMake(260*screenWidth/320, 28*screenWidth/320, 50*screenWidth/320, 15*screenWidth/320)];
